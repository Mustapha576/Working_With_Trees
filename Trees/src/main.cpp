...
int main(int argc, char**argv) {
    ...
    sector_map_BST.readSectorsFromFile("sectors.dat");
    ...
    sector_map_LLRBT.readSectorsFromFile("sectors.dat");
    sector_map_LLRBT.displaySectorsInOrder();
    sector_map_LLRBT.displaySectorsPreOrder();
    sector_map_LLRBT.displaySectorsPostOrder();

    std::vector<Sector*> stellar_path_2 = sector_map_LLRBT.getStellarPath("108RDF");
    sector_map_LLRBT.printStellarPath(stellar_path_2);

    cout << endl;

    stellar_path_2 = sector_map_LLRBT.getStellarPath("125RUB");
    sector_map_LLRBT.printStellarPath(stellar_path_2);

    stellar_path_2 = sector_map_LLRBT.getStellarPath("88RUF");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("70RDF");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("93LDB");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("70LDF");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("33LDB");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("96LDB");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
    stellar_path_2 = sector_map_LLRBT.getStellarPath("55LUB");
    sector_map_LLRBT.printStellarPath(stellar_path_2);
